...
Subnet 1 is created by `init`. Additional subnets use `init_subnet`, and all subnet-specific functions have `*_for_subnet` variants. The Python client defaults to `SUBNET_ID=1`.
